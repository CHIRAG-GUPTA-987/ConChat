...
const UpdateGroupChat = ({ children, overlay, user, closeContext, chat }) => {
  ...
  const updateGroupNameHandler = async () => {
    ...
    try {
      ...
      const url = `${process.env.REACT_APP_BACKENDURL}/api/chat/group/rename`;
  ...
  const addUserHandler = async (newUser) => {
    ...
    try {
      ...
      const url = `${process.env.REACT_APP_BACKENDURL}/api/chat/group/adduser`;
      const { data } = await axios.put(
        url,
        {
          chatId: chat._id,
  ...
  const removeUserHandler = async (gM) => {
    ...
    try {
      ...
      const url = `${process.env.REACT_APP_BACKENDURL}/api/chat/group/remove`;
      const { data } = await axios.put(
        url,
        {
          chatId: chat._id,
